...
> ⚠️ **本期数据源说明（2026-09-14）**
> arXiv 出口 API（export.arxiv.org）本期对本机 IP 返回持续的 HTTP 429 / 503，31 个关键词中仅 1 个成功，arXiv 通道近乎不可用（arXiv 官方状态页显示服务正常，判定为反滥用限流/出口降级）。
> 因此本期 163 篇论文中 **153 篇来自 Semantic Scholar**、仅 **10 篇来自 arXiv**，arXiv 新预印本覆盖度显著低于常规周次。
> 已新增 `scripts/arxiv_prefetch.py`（带重试与节流的直连预取器）以提升后续周次的抓取韧性；下期应复核 arXiv 通道是否恢复。
...
### 1. When the Tool Agrees with You: Large Language Model Sycophancy, Examiner Impartiality, and the Admissibility of AIAssisted Forensic Opinion
- **来源**: SEMANTIC_SCHOLAR
- **作者**: Devharsh Trivedi
- **发表**: 2026
- **最终评分**: 9/10
...
### 2. SYCOPHANCY AS AN INVERSE-SCALING PHENOMENON: EMPIRICAL EVIDENCE AND A FEEDBACK LOOP MODEL OF BIAS AMPLIFICATION IN LLM-ASSISTED DECISION-MAKING
- **来源**: SEMANTIC_SCHOLAR
- **作者**: I. Ivitskiy
- **发表**: 2026
- **最终评分**: 9/10
...
### 3. AI Research Agents Narrow Scientific Exploration
- **来源**: SEMANTIC_SCHOLAR
...
### 4. Layer-sensitive cognitive offloading in generative AI-assisted writing: supported performance and independent no-AI outcomes
- **来源**: SEMANTIC_SCHOLAR
- **作者**: Xin-Ran Chen
- **发表**: 2026
- **最终评分**: 8/10
...
### 5. When AI Speaks, Whose Values Does It Express? A Cross-Cultural Audit of Individualism-Collectivism Bias in Large Language Models
- **来源**: SEMANTIC_SCHOLAR
...
### 6. Trait-space Monitoring for Emergent Misalignment During Supervised Finetuning
- **来源**: SEMANTIC_SCHOLAR
...
### 7. Preference Drift in AI Agents: How Work Design Affects Behavioral Alignment
- **来源**: SEMANTIC_SCHOLAR
...
### 8. Political Alignment in Large Language Models: A Multidimensional Audit of Psychometric Identity and Behavioral Bias
- **来源**: SEMANTIC_SCHOLAR
...
### 9. Evolvable AI: Threats of a new major transition in evolution
- **来源**: SEMANTIC_SCHOLAR
...
### 10. Why AI Economics Fail: Cost Structures, Billing Models, and Stalled Adoption
- **来源**: SEMANTIC_SCHOLAR
- **作者**: A. Jacobson
- **发表**: 2026
- **最终评分**: 8/10
...
### 12. Creation, validation, obsolescence: observed evidence of AI-driven labor market displacement, 2020–2025
- **来源**: SEMANTIC_SCHOLAR
- **作者**: Nassim Dehouche
- **发表**: 2026
- **最终评分**: 8/10
...
### 13. Memory Scarcity, Open Models, and the Restructuring of the AI Industry, 2026-2030 - A quantitative scenario analysis of inference economics, training-cost divergence, and infrastructure solvency
- **来源**: SEMANTIC_SCHOLAR
- **作者**: Satoshi Matsuoka
- **发表**: 2026
- **最终评分**: 8/10
...
### 14. Tiered Super-Moore's Law: Price Evolution, Production Frontiers, and Market Competition in Large Language Model Inference Services
- **来源**: SEMANTIC_SCHOLAR
- **作者**: Ming Du
- **发表**: 2026
- **最终评分**: 8/10
...
### 15. The Epistemic Costs of Super-Persuasive AI
- **来源**: SEMANTIC_SCHOLAR
- **作者**: A. Deller
- **发表**: 2026
- **最终评分**: 8/10
...
### 16. Artificial Id: Drive and Persistent Alignment in Agentic AI
- **来源**: ARXIV
...
### 17. A Conceptual Study for Cognitive Bias Amplification in Agentic AI-Driven Business Processes, Management, and Intelligence
- **来源**: SEMANTIC_SCHOLAR
...
### 18. What is Wrong With Automation Bias?
- **来源**: SEMANTIC_SCHOLAR
...
### 19. Profiling cognitive offloading in LLM-mediated synthesis writing: Volume vs. content
- **来源**: SEMANTIC_SCHOLAR
...
### 20. Diversifying Personalized Research Ideation against AI-Induced Homogenization
- **来源**: SEMANTIC_SCHOLAR
...
### 21. Stumbling Into AI Emotional Dependence: How Routine AI Interactions Reshape Human Connection
- **来源**: SEMANTIC_SCHOLAR
...
### 22. AlignInsight: A Three-Layer Framework for Detecting Deceptive Alignment and Evaluation Awareness in Healthcare AI Systems
- **来源**: SEMANTIC_SCHOLAR
...
### 23. Digital Darwinism: steering the evolution of artificial life in socio-technical systems
- **来源**: SEMANTIC_SCHOLAR
- **作者**: Karl T. Ulrich
- **发表**: 2026
- **最终评分**: 7/10
...
### 24. From Assistance to Dependence: The Cognitive Cost of Artificial Intelligence in Education.
- **来源**: SEMANTIC_SCHOLAR
- **作者**: N. Kalal, N. Rana
- **发表**: 2026
- **最终评分**: 7/10
...
### 25. Toward a science of human–AI teaming for decision making: A complementarity framework
- **来源**: SEMANTIC_SCHOLAR
...
### 26. The AI Automation Paradox: Why Perfect Foresight Cannot Stop the Race to the Cliff
- **来源**: SEMANTIC_SCHOLAR
- **作者**: Jonathan H. Westover
- **发表**: 2026
- **最终评分**: 7/10
...
### 27. Technological Polarization and Unequal Growth in the Era of Generative Artificial Intelligence
- **来源**: SEMANTIC_SCHOLAR
- **作者**: Kyra Mahindru
- **发表**: 2026
- **最终评分**: 7/10
...
### 28. Universal Basic Income Pilots: Comparative Outcomes and Design Lessons
- **来源**: SEMANTIC_SCHOLAR
- **作者**: Sarah Sachar
- **发表**: 2026
- **最终评分**: 7/10
...
### 29. What Counts as AI Sycophancy? A Taxonomy and Expert Survey of a Fragmented Construct
- **来源**: SEMANTIC_SCHOLAR
...
### 30. Agentic AI and the next intelligence explosion
- **来源**: SEMANTIC_SCHOLAR
...
### 32. Recursive Self-Improvement in AI: From Bounded Self-Refinement to Autonomous Research Loops
- **来源**: SEMANTIC_SCHOLAR
